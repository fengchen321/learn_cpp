...
JSONObject::JSONObject() : inner(nullptr) {}
JSONObject::JSONObject(std::nullptr_t) : inner(nullptr) {}
JSONObject::JSONObject(bool b) : inner(b) {}
JSONObject::JSONObject(int i) : inner(i) {}
JSONObject::JSONObject(double d) : inner(d) {}
JSONObject::JSONObject(const std::string& str) : inner(str) {}
JSONObject::JSONObject(JSONList list) : inner(std::move(list)) {}
JSONObject::JSONObject(JSONDict dict) : inner(std::move(dict)) {}

void JSONObject::do_print() const {
    std::visit([](auto&& arg) {
